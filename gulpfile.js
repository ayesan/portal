...
gulp.task('serve:dev', gulp.series('inject', 'watch', 'browsersync'));
gulp.task('serve', gulp.series('partials', 'inject', 'watch','nodemon', 'bsync'));
...
gulp.task('bsync', function() {
  browserSync.init({
      ...
      startPath: '/x/',
      serveStatic: ['.','./bower_components','./client'],
      port: 5000,
      notify: true,
      open: true
   });
